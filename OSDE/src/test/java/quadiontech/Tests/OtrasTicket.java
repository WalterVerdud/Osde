...
public class OtrasTicket extends BasePage {
    ...
    public void otrasPrestaciones() throws InterruptedException, IOException {
        ...
        WebElement ElegirSocio = wait.until(ExpectedConditions.visibilityOfElementLocated(GestionarReintegrosPage.Socio1));
        ElegirSocio.click();
        WebElement Practicas = wait.until(ExpectedConditions.visibilityOfElementLocated(GestionarReintegrosPage.ComboBoxLocator));
        Practicas.click();
        WebElement TipoPractica = wait.until(ExpectedConditions.visibilityOfElementLocated(GestionarReintegrosPage.PracticaLocator8));
        TipoPractica.click();
