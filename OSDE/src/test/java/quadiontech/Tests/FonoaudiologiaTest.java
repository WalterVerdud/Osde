...
public class FonoaudiologiaTest extends BasePage {
    ...
    public void Fonoaudiologia() throws InterruptedException, IOException {
        ...
        WebElement ElegirSocio1 = wait.until(ExpectedConditions.visibilityOfElementLocated(GestionarReintegrosPage.Socio1));
        ElegirSocio1.click();
        WebElement Practicas = wait.until(ExpectedConditions.visibilityOfElementLocated(GestionarReintegrosPage.ComboBoxLocator));
        Practicas.click();
        Thread.sleep(2000);
        WebElement TipoPractica = wait.until(ExpectedConditions.visibilityOfElementLocated(GestionarReintegrosPage.PracticaLocator2));
        TipoPractica.click();
        ...
        AdjuntarComp.sendKeys("C:/Users/Walter/IdeaProjects/OSDE/src/test/resources/Adjuntos/TestAdjuntoOsde.pdf");
        ...
        File screenshotFile = new File("C:\\Users\\Walter\\IdeaProjects\\OSDE\\src\\test\\resources\\CapturasReintegros\\Fonoaudiologia.png");
