...
public class ProdOrtopediaTicket extends BasePage {
    ...
    public void productosOrtopedia() throws InterruptedException, IOException {
        ...
        Practicas.click();
        WebElement TipoPractica = wait.until(ExpectedConditions.visibilityOfElementLocated(GestionarReintegrosPage.PracticaLocator6));
        TipoPractica.click();
