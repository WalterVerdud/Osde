...
public class Nutriciontest extends BasePage {
    ...
    public void nutricion() throws InterruptedException, IOException {
        ...
        Practicas.click();
        Thread.sleep(2000);
        WebElement TipoPractica = wait.until(ExpectedConditions.visibilityOfElementLocated(GestionarReintegrosPage.PracticaLocator1));
        TipoPractica.click();
        ...
        File screenshotFile = new File("C:\\Users\\Walter\\IdeaProjects\\OSDE\\src\\test\\resources\\CapturasReintegros\\Nutricion.png");
